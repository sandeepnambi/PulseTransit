...
export default function AuthModal() {
  ...
  const handleFillDemoDriver = () => {
    setEmail('driver@pulsetransit.com');
        ...
        <div className="pt-3 border-t border-slate-200 space-y-2">
          ...
          <div className="grid grid-cols-3 gap-2">
            <button
              ...
              className="py-2 px-1 rounded-lg bg-slate-100 hover:bg-slate-200 text-[11px] text-slate-700 font-semibold transition text-center"
            >
              Passenger
            </button>
            <button
